...
KeysBehaviour::KeysBehaviour(float pMoveSpeed, float pTurnSpeed, float pFlySpeed): AbstractBehaviour(), _moveSpeed(pMoveSpeed), _turnSpeed(pTurnSpeed), _flySpeed(pFlySpeed)
{
}
