...
UnlitTextureMaterial::UnlitTextureMaterial(Texture* pDiffuseTexture, float pTiling):
_diffuseTexture(pDiffuseTexture), _tiling(pTiling) {
...
void UnlitTextureMaterial::render(Mesh* pMesh, const glm::mat4& pModelMatrix, const glm::mat4& pViewMatrix, const glm::mat4& pProjectionMatrix) {
	...
	glUniform1f(_shader->getUniformLocation("tiling"), _tiling);
