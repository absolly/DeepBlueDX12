#ifndef DEBUG_RENDERER_MATERIAL_H_
#define DEBUG_RENDERER_MATERIAL_H_
 ...
 */
class DebugRenderMaterial
{
    public:
		DebugRenderMaterial(glm::vec3 pColor = glm::vec3(1,0,0));
        virtual ~DebugRenderMaterial();
...
#endif // DEBUG_RENDERER_MATERIAL_H_
