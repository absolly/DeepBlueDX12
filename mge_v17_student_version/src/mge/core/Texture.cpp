...
#ifdef API_DIRECTX
ID3D12DescriptorHeap* Texture::mainDescriptorHeap = nullptr;
UINT Texture::mCbvSrvDescriptorSize = 0;
UINT Texture::texCount = 0;
#endif // API_DIRECTX
...
ID3D12Resource* Texture::CreateTextureDefaultBuffer(
	const void* initData,
	int bytesPerRow,
	D3D12_RESOURCE_DESC& textureDesc,
	ID3D12Resource*& uploadBuffer)
{
	...
	Renderer::commandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer,
		D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_STATE_COPY_DEST));
	UpdateSubresources<1>(Renderer::commandList, defaultBuffer, uploadBuffer, 0, 0, 1, &subResourceData);
	Renderer::commandList->ResourceBarrier(1, &CD3DX12_RESOURCE_BARRIER::Transition(defaultBuffer,
...

{
	...
	else if (wicFormatGUID == GUID_WICPixelFormat24bppBGR) return GUID_WICPixelFormat32bppBGRA;
