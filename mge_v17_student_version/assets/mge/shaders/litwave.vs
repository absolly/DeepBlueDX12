...
void main( void ) {
	...
	vec3 newvertex = vertex + vec3((waveSize.r * waveMultiplier) * cos((_time * speed * 0.02)  + (vertex.z * 0.3) + (vertex.y * 0.5)), (waveSize.g * waveMultiplier) * cos((_time * speed*0.02) + (vertex.z * 0.0001)),(waveSize.b * waveMultiplier) * cos((_time * speed *0.02) + (vertex.z * 0.001)));
